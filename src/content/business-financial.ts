...
export const businessFinancialCategory: ServicePageContent = {
  ...
  trustPoints: ['Funding Network', 'Credit Strategy', 'Nationwide Service'],
  introHeading: 'Filing a return is one part of a financial picture',
  intro: [
  ...
  handleIntro:
    'The financial work that sits alongside tax and accounting, for individuals and business owners alike.',
  handles: [
    'Working capital and short-term business funding',
    'Cash flow financing and expansion capital',
    'Personal and business credit report review',
    'Credit dispute strategy and credit-building guidance',
    'Business credit profile development',
    'Unclaimed property and dormant account searches',
    'Taxpayer overpayment identification and claims',
    'Entity structure and formation guidance',
    'Financial strategy and growth planning',
    'Mentorship and education for new business owners',
  ],
  ...
  process: [
    {
      ...
      body: 'We learn what you are trying to accomplish and whether what you need is funding, credit work, recovery, or advice.',
    },
    {
    ...
    {
      title: 'Match & Apply',
      body: 'We connect you with the right path, prepare what needs preparing, and handle the submission and follow-up.',
    },
    {
      title: 'Follow Through',
      body: 'We stay involved after the application or claim goes in, and tell you honestly where things stand at each stage.',
    },
  ],
  faqs: [
    {
      question: 'Do I have to be a tax client to use these services?',
      answer:
        'No. Funding, credit, recovery, and consulting all stand on their own. Being a tax client sometimes speeds things up, since we already have the financial documentation an application needs, but it is not a prerequisite.',
    },
    {
      question: 'Are these services available outside New York?',
      answer:
        'Yes. All four are handled remotely for clients nationwide. Unclaimed funds work in particular is inherently multi-state, since money is held by whichever state last had a claim on it.',
    },
    {
...
export const businessLoansFunding: ServicePageContent = {
  href: '/services/business-financial-solutions/business-loans-funding',
  h1: 'Small Business Loans & Funding',
  eyebrow: 'Business & Financial Solutions',
  heroSubtitle:
    'Working capital and expansion funding, matched to your business through our network of lending partners.',
  metaTitle: 'Small Business Loans & Funding | The Arms Corporation',
  metaDescription:
    'Access working capital and business funding options through The Arms Corporation lending partner network. Bronx, NY office, serving business owners nationwide.',
  ...
  handleHeading: 'What we handle',
  handleIntro:
    'Funding needs we help business owners pursue through our partner network.',
  handles: [
    'Working capital for day-to-day operations',
    'Short-term financing to bridge cash flow gaps',
    'Funding to take on a new contract or opportunity',
    'Equipment and expansion financing',
    'Application preparation and documentation review',
    'Financial statement packaging for lender submission',
    'Guidance on which options fit your time in business and revenue',
  ],
  ...
  process: [
    {
      ...
      body: 'We look at revenue, time in business, cash flow, and credit to understand what you realistically qualify for before anything is submitted.',
    },
    {
      title: 'Partner Matching',
      body: 'We identify funding partners in our network whose criteria fit your profile, and help you prepare the documentation each one requires.',
    },
    {
      title: 'Submission & Funding',
      body: 'We support the submission and follow up through underwriting. The funding partner makes the decision and sets the terms; we keep you informed throughout.',
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'Requirements vary considerably by partner and product. Some options are geared toward established businesses with substantial operating history; others are available earlier. Rather than guess, tell us how long you have been operating and what your revenue looks like, and we will tell you which paths are realistic.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Commonly: recent business bank statements, tax returns, a profit and loss statement, and basic entity documentation. The exact list depends on the partner and the amount. If your financials are not assembled, that is something we can help with directly.',
    },
    {
      question: 'What if my credit is not strong?',
      answer:
        'It narrows the options but does not always eliminate them, since some funding decisions weight business revenue and cash flow more heavily than personal credit. If credit is the binding constraint, our credit solutions service is often the more productive place to start.',
    },
    {
  ...
  disclaimer:
    'The Arms Corporation works with a network of third-party lending and funding partners. We are not a direct lender. All approvals, funding amounts, rates, and terms are determined solely by the funding partner based on their own underwriting criteria. Submitting an application does not guarantee approval or any particular terms.',
};

export const creditSolutions: ServicePageContent = {
  href: '/services/business-financial-solutions/credit-solutions',
  h1: 'Credit Solutions',
  eyebrow: 'Business & Financial Solutions',
  heroSubtitle:
    'A clear read on what is actually on your credit report, and a realistic strategy for what to do about it.',
  metaTitle: 'Credit Solutions | The Arms Corporation',
  metaDescription:
    'Personalized credit review, dispute strategy, and credit-building guidance for individuals and businesses from The Arms Corporation. Bronx, NY and nationwide.',
  ...
  handleHeading: 'What we handle',
  handleIntro:
    'Credit work for individuals and business owners, personal profile and business profile alike.',
  handles: [
    'Full credit report review across the major bureaus',
    'Identifying inaccurate, outdated, or misattributed items',
    'Dispute strategy and documentation guidance',
    'Credit utilization and payment timing guidance',
    'Credit-building strategy for thin or damaged profiles',
    'Business credit profile setup and development',
    'Preparing a credit profile ahead of a funding application',
  ],
  processHeading: 'Three steps to a clearer profile',
  processIntro:
    'Starting with information rather than assumptions.',
  process: [
    {
      title: 'Report Review',
      body: 'We pull and read your full report together, so you understand exactly what is being reported and by whom.',
    },
    {
      title: 'Strategy',
      body: 'We separate items with a legitimate dispute basis from those without, and lay out a realistic plan including what only time and habit will change.',
    },
    {
      title: 'Execute & Monitor',
      body: 'We guide you through the process, help with documentation, and track how the profile responds over the following cycles.',
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'We will not give you a number, because no one honestly can. Scores respond to a mix of factors, and how a specific profile moves depends on what is on it, what changes, and how much history sits behind it. We can explain which factors are weighing on your profile and what tends to influence them.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, and you are entitled to. You can request your reports and file disputes directly with the bureaus at no cost. People work with us because reading the report accurately, deciding what is worth disputing, and knowing what documentation supports a dispute is where the process actually gets difficult.',
    },
    {
      question: 'What is business credit and do I need it?',
      answer:
        'Business credit is a profile tied to your business rather than to you personally, tracked by its own bureaus. It matters for financing terms, vendor relationships, and reducing how much of your business borrowing depends on a personal guarantee. If you plan to seek funding, establishing it early is worth doing.',
    },
    {
      question: 'Should I fix my credit before applying for funding?',
      answer:
        'Frequently, yes. A declined application does not improve your position, and some funding options weigh credit heavily. During the consultation we look at both together and tell you whether it makes more sense to apply now or to spend a few months on the profile first.',
    },
  ],
  disclaimer:
    'Credit repair services are regulated under the Credit Repair Organizations Act and applicable state law. We do not guarantee any score increase, the removal of any specific item, or any particular outcome. Accurate and verifiable information generally cannot be removed from a credit report. You have the right to dispute inaccurate information with the credit bureaus yourself, at no cost, and to obtain your credit reports directly.',
};

export const unclaimedFundsRecovery: ServicePageContent = {
  href: '/services/business-financial-solutions/unclaimed-funds-recovery',
  h1: 'Unclaimed Funds & Tax Overpayment Recovery',
  eyebrow: 'Business & Financial Solutions',
  heroSubtitle:
    'States and treasuries hold billions in unclaimed property. Some of it belongs to people who have no idea it exists.',
  metaTitle: 'Unclaimed Funds & Tax Overpayment Recovery | The Arms Corporation',
  metaDescription:
    'Find out whether you are owed unclaimed property or a tax overpayment. The Arms Corporation helps individuals and businesses recover what is theirs, nationwide.',
  ...
  handleHeading: 'What we handle',
  handleIntro:
    'Recovery work for individuals, families, and businesses across state lines.',
  handles: [
    'Multi-state unclaimed property database searches',
    'Searches under prior names, addresses, and former business entities',
  ...
  processIntro:
    'It begins with a search that costs you nothing but the conversation.',
  process: [
    {
      title: 'Search',
      body: 'We search state databases and review your filing history for property or overpayments held in your name or your business name.',
    },
    {
      title: 'Claim Filing',
      body: 'We assemble the documentation each holding agency requires and prepare the claim so it is not rejected on a technicality.',
    },
    {
      title: 'Recovery',
      body: 'We follow the claim through the agency’s process, respond to requests for additional proof, and keep you posted until it is resolved.',
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'It depends on the holding agency and the type of property. Some claims are processed in a matter of weeks; others involving estates, dissolved businesses, or extensive documentation take considerably longer. Once we know which agency holds the property, we can give you a realistic expectation.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, and this is why searching more than one state matters. Property is generally held by the state connected to your last known address with that company, which may be somewhere you lived years ago. We search across states rather than assuming your current one.',
    },
    {
...
export const businessConsulting: ServicePageContent = {
  ...
  trustPoints: ['Entity Structure', 'Financial Strategy', 'New Owner Mentorship'],
  introHeading: 'Most small business advice is either too generic or too expensive',
  intro: [
  ...
  handles: [
    ...
    'Growth planning and hiring readiness',
    'Compliance and record-keeping requirements',
    'Education and mentorship for first-time business owners',
    'Preparing a business to seek funding',
  ],
  processHeading: 'How consulting engagements work',
  processIntro:
    'Some clients need one focused session; others want an ongoing sounding board.',
  process: [
    {
      title: 'Discovery',
      body: 'We learn what the business is, where it stands, and what decision or obstacle actually brought you here.',
    },
    {
      title: 'Analysis',
    ...
    {
      title: 'Plan & Support',
      body: 'You get a clear plan with the reasoning behind it, and we stay available as you implement it and things change.',
    },
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        'It varies with what you need. Some clients come with one specific decision and want a focused session. Others want a recurring check-in as the business grows. We will recommend a shape based on your situation rather than selling you a package.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, and it is a common question. Hiring costs more than the salary once payroll taxes, insurance, and administrative time are counted. We model the full cost against your cash flow and margins so the decision rests on numbers rather than optimism.',
    },
    {
      question: 'Do I need to use your tax or bookkeeping services too?',
      answer:
        'No. Consulting is available on its own. It does tend to be sharper when we can see current books and prior returns, but if you keep those elsewhere we will work from whatever you can share.',
    },
    {
      question: 'What if I mostly need someone to tell me whether my plan is sound?',
      answer:
        'That is a legitimate engagement and a valuable one. Bring us the plan and we will pressure-test the assumptions, particularly the financial ones, and tell you where we think it holds and where it does not.',
    },
  ],
};

export const businessFinancialPages = [
